...
export default async function EventPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const event = eventss.find((e) => e.slug === slug);
    if (!event) return notFound();
        ...
        return   ( <section className="bg-green-50 pb-12 px-4 md:px-12">
                <Span
                ...
                >
                    ...
                    <Card className="mb-6 rounded-2xl flex justify-center items-center shadow-md">
                        <CardContent className="p-6">
                    ...
                    <div className="text-center mt-8">
                        ...
                        >
                            <a href="https://wa.me/message/UNMD7XAC5KFUB1" target="_blank">
